...
@CreoleResource(name = "Chinese Tokeniser", comment = "A customisable Chinese tokeniser.", helpURL = "http://gatechinese.com", icon = "tokeniser") 
public class ChineseTokeniser extends AbstractLanguageAnalyser {
	  private static final long serialVersionUID = 8197616342229149266L;
	  ...
	  public Resource init() throws ResourceInstantiationException{
		  try {
			  ...
			  checkParameters();
		      if (tokeniser == null) {
		    	  tokeniser = new NlpirAsTokeniser();
		      }     
		      if(!tokeniser.init(1,userDict))
	...
	   */
	  ...
	  /** the NlpirAsTokeniser*/
	  protected NlpirAsTokeniser tokeniser;
	  ...
	  public void execute() throws ExecutionException { 
		  ...
		  try {
		      ...
		      for(int index=0;index<paragramcount;index++) {
		          ...
		          String tokenswithpos = tokeniser.Process(paragram,encoding,nposType);
